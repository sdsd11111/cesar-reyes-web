    ...
    <div className="bg-white">
      ...
      <section className="py-20 px-4 bg-white">
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          ...
          >
            <img src="/images/menuobjetivo/video-explicativo-thumbnail.webp" alt="Video explicativo de Menú Objetivo" className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" />
