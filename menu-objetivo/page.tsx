  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
        <img src="/images/menu-objetivo/menu-digital-restaurantes-hero.webp" alt="Menú digital para restaurantes" className="absolute z-0 w-full h-full object-cover" />
      ...
      <section className="py-20 px-4 bg-[#F9F9F9]">
        ...
        <div className="mt-16 max-w-6xl mx-auto px-4">
          <CardSlider>
            <div className="relative aspect-[9/16] bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col p-8 overflow-hidden">
              <img src="/images/menu-objetivo/solucion-actualizar-menu-digital-facil.webp" alt="Control Total en 1 Minuto" className="absolute inset-0 w-full h-full object-cover z-0" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
              <div className="relative z-20 text-white flex flex-col h-full justify-center">
            ...
            <div className="relative aspect-[9/16] bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col p-8 overflow-hidden">
              <img src="/images/menu-objetivo/solucion-posicionamiento-google-restaurantes.webp" alt="Visible Cuando Te Buscan" className="absolute inset-0 w-full h-full object-cover z-0" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
              <div className="relative z-20 text-white flex flex-col h-full justify-center">
            ...
            <div className="relative aspect-[9/16] bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col p-8 overflow-hidden">
              <img src="/images/menu-objetivo/solucion-enlace-menu-digital-whatsapp.webp" alt="El Poder del Menú Digital" className="absolute inset-0 w-full h-full object-cover z-0" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
              <div className="relative z-20 text-white flex flex-col h-full justify-center">
      ...
      <section className="py-20 px-4 bg-white">
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div 
            className="relative w-full h-[400px] rounded-xl shadow-xl overflow-hidden cursor-pointer group"
            onClick={() => openModal('https://www.youtube.com/watch?v=oPySzkvDjDk')}
          >
            <img src="/images/menu-objetivo/video-explicativo-thumbnail.webp" alt="Video explicativo de Menú Objetivo" className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" />
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
              <div className="text-center">
                <PlayCircle className="w-16 h-16 text-white mx-auto mb-2 transition-transform duration-300 group-hover:scale-110" />
