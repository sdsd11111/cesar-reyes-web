...
export default function FaqSectionNew() {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-4">
          <p className="font-medium">Renovación del dominio y hosting: <span className="text-blue-600">$30/año</span></p>
    ...
    {
      question: '¿Por qué tan barato si dices que vale $605?',
      answer: (
        <div className="space-y-4">
          ...
          <div className="space-y-6">
            ...
            <div>
              <p className="font-bold text-blue-700">2. EFICIENCIA</p>
              <p>Usamos código optimizado, no WordPress lento. Hacemos páginas en 1/3 del tiempo.</p>
            </div>
