...
const QUESTIONS: QuizQuestion[] = [
  {
    id: 1,
    text: "¿El 80% de tus reservas vienen de Booking o Expedia?",
    icon: 'Search' as const,
    yesOption: "Sí, dependo de ellas",
    noOption: "No, tengo directas",
    yesFeedback: "Cuidado. Si Booking cambia su algoritmo mañana, tu hotel se queda vacío. Además, estás perdiendo un 15-20% de margen en cada reserva. Necesitas un canal propio urgente.",
    noFeedback: "¡Excelente! Pero ¿estás maximizando ese canal? Si no tienes un motor de reservas automatizado en tu web, sigues perdiendo clientes que quieren confirmar al instante y se van a la competencia.",
    image: "/images/google.webp",
    imageDescription: "Imagen representativa de reservas online"
  },
  {
    id: 2,
    text: "¿Pagas comisiones por clientes que YA te conocen (recurrentes)?",
    icon: 'BarChart' as const,
    yesOption: "Sí, me reservan por App",
    noOption: "No, me llaman directo",
    yesFeedback: "Estás regalando dinero. Si un cliente ya conoce tu hotel, debería reservar directo contigo sin comisión. Un sistema de fidelización digital convierte esos huéspedes en reservas 100% tuyas.",
    noFeedback: "Bien, pero gestionar llamadas/chats consume tiempo operativo. ¿Qué pasa si llaman de noche? Un motor de reservas trabaja 24/7 sin cansarse y sin cobrar sueldo.",
    image: "/images/busquedas_mensuales.webp",
    imageDescription: "Gráfico de comisiones vs ingresos directos"
  },
  {
    id: 3,
    text: "¿Tu hotel se llena solo en feriados y temporada alta?",
    icon: 'Eye' as const,
    yesOption: "Sí, sufro en temporada baja",
    noOption: "No, tengo ocupación estable",
    yesFeedback: "El 'dolor' de las habitaciones vacíos se cura con datos. No tienes una estrategia de demanda. Con marketing digital activo, puedes atraer turismo corporativo o local para llenar esos huecos.",
    noFeedback: "Perfecto. El siguiente nivel es aumentar el ticket promedio. ¿Estás vendiendo servicios adicionales (tours, cenas, spa) antes de que lleguen? Tu web debería estar vendiendo eso por ti.",
    image: "/images/palabras_claves.webp",
    imageDescription: "Calendario de ocupación hotelera"
  },
  {
    id: 4,
    text: "¿Tienes una base de datos propia de tus huéspedes para hacerles ofertas?",
    icon: 'ThumbsUp' as const,
    yesOption: "Sí, tengo emails/teléfonos",
    noOption: "No, Booking se queda todo",
    yesFeedback: "El activo más valioso es tu lista. Si la tienes, ¿la usas? Email marketing bien hecho puede llenar tu hotel en un fin de semana flojo con costo cero en publicidad.",
    noFeedback: "Ese es el mayor riesgo. Si no tienes los datos, el cliente es de la plataforma, no tuyo. Construir tu base de datos es el primer paso para la libertad financiera de tu hotel.",
    image: "/images/google.webp",
    imageDescription: "Base de datos de clientes"
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="p-6 md:p-10">
        {/* Título con gradiente (Mantiene estructura del usuario) */}
          ...
          {!showResults ? (
            ...
            >
              {!showFeedback ? (
                ...
                <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700 space-y-6">
                  ...
                  <div className="flex justify-center">
                    <button
                      className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary hover:bg-primary/90 py-2 bg-gradient-to-r from-white to-gray-200 hover:from-gray-100 hover:to-gray-300 text-gray-900 h-12 px-8 text-base"
                      type="button"
              ...
              {currentQuestion > 0 && (
                <div className="flex justify-center">
                  <button
                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent h-10 px-4 py-2 text-gray-400 hover:text-white"
                    type="button"
              ...
              {/* Indicadores de progreso inferiores - Mantenemos para UX aunque haya barra superior */}
              {!showFeedback && (
