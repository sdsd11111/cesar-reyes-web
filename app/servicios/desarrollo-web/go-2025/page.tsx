          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center py-16 md:py-24">
              ...
              <div className="max-w-4xl mx-auto mb-8 px-4">
                <HeroText 
                  fullText="Inicia tu presencia digital con una página estática que posiciona tu marca y atrae clientes sin costos recurrentes. Por solo 250 USD único, obtén un sitio intuitivo con dominio propio, botones WhatsApp y SEO básica, mejor que una tarjeta digital para mostrar productos y ganar leads orgánicos."
                  shortText="Inicia tu presencia digital con una página estática que posiciona tu marca y atrae clientes sin costos recurrentes. Por solo 250 USD único, obtén un sitio intuitivo con dominio propio, botones WhatsApp y SEO básica, mejor que una tarjeta digital para mostrar productos y ganar leads orgánicos."
