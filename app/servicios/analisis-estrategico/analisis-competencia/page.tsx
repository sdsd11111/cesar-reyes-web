...
// Componente HeroText para manejar el texto expandible
...
const HeroText = ({ fullText, shortText, className = '', textColor = 'text-gray-200' }: HeroTextProps) => {
  ...
  return (
    <div className={className}>
      <p className={`text-base md:text-lg lg:text-xl ${textColor} leading-relaxed`}>
        {isExpanded ? (
          <>
            {fullText}
            <button 
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center text-white">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <HeroText 
              fullText="¿Te preocupa que tus competidores te estén dejando atrás mientras tú intentas adivinar qué hacer? En el mundo digital, no saber qué hace tu competencia es como jugar con los ojos vendados."
              shortText="¿Te preocupa que tus competidores te estén dejando atrás mientras tú intentas adivinar qué hacer? En el mundo digital, no saber qué hace tu competencia es como jugar con los ojos vendados."
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="#contacto" className="w-full sm:w-auto">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 md:px-8 rounded-lg text-sm sm:text-base md:text-lg transition-all duration-300 transform hover:scale-105 w-full sm:w-auto whitespace-normal h-auto min-h-[52px] flex items-center justify-center text-center">
