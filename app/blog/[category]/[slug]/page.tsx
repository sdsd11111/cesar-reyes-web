...
export default async function BlogPostPage({ 
  ...
  // Obtener el artículo específico y artículos relacionados en paralelo
  ...
  const relatedArticles = allArticles
    .filter((a): a is ValidArticle => {
      if (!isValidArticle(a)) {
        return false;
      }
      
      // Verificar que no sea el artículo actual y que sea de la misma categoría
      const isSameCategory = a.category?.toLowerCase() === article.category?.toLowerCase();
      const isNotCurrent = a.slug !== article.slug;
    ...
    .map(relatedArticle => ({
      ...relatedArticle,
      title: relatedArticle.title || 'Sin título',
      excerpt: relatedArticle.excerpt || '',
      date: relatedArticle.date || new Date().toISOString(),
      image: relatedArticle.image || '/images/placeholder.jpg',
      author: relatedArticle.author || 'César Reyes Jaramillo'
    }));
