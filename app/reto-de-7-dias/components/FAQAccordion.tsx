  ...
  const faqItems = [
    {
      ...
      answer: (
        <div className="space-y-4">
          <p className="font-bold">¿Por qué regalamos $2,000 en implementación y estrategia?</p>
          <p>Porque queremos que te conviertas en un caso de éxito visible.</p>
          <p>Si tu restaurante empieza a aparecer en Google... TÚ vas a contarles a otros dueños. Ese marketing de boca a boca vale más que los $2,000 que invertimos en ti.</p>
          <p>Además, solo ganas si completas el reto. Eso significa que: 
            <span className="block">✅ Estás comprometido (invertiste 7 días)</span>
            <span className="block">✅ Estás educado (leíste nuestros artículos)</span>
            <span className="block">✅ Entiendes el producto (sabes qué esperar)</span>
          </p>
          <p>Ganadores comprometidos = Casos de éxito reales. Ganar-ganar.</p>
          <p className="font-bold">¿Hay letra pequeña?</p>
          <p>El único "requisito" es que completes las 7 preguntas. El premio de $2,000 en servicios se aplica automáticamente.</p>
        </div>
      )
    },
    {
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-4">
          ...
          <p>Los restaurantes pequeños (5-20 mesas) NO pueden pagar eso. Por eso nuestra solución es perfecta para ti:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>✅ Implementación y Estrategia: $500 (Gracias al Reto)</li>
