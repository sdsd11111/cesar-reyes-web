...
export const metadata: Metadata = {
    ...
    keywords: ["hotel digital", "hoteles ecuador", "gestión hotelera", "reservas online", "hotel qr", "quito", "guayaquil", "loja", "hotel online"],
    openGraph: {
        ...
        images: [
            {
                url: "/images/menu-objetivo/menu-digital-restaurantes-hero.webp", // Keeping same image for now as placeholder
                width: 1200,
                height: 630,
