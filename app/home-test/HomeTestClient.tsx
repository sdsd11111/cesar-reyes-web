          ...
          <section className="w-full bg-[#121212] py-20">
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-3xl mx-auto text-center mt-16">
                ...
                <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-11 rounded-md px-4 sm:px-8 mt-8 font-bold bg-blue-600 hover:bg-blue-700 text-white text-center">
          ...
          <section className="w-full py-20 md:py-28 bg-white">
            <div className="container mx-auto px-4">
              ...
              <div className="text-center mt-12 px-4">
                <button className="w-full max-w-xs mx-auto sm:w-auto inline-flex items-center justify-center gap-2 whitespace-normal sm:whitespace-nowrap text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-12 sm:h-11 rounded-lg sm:rounded-md px-6 sm:px-8 font-bold bg-blue-600 hover:bg-blue-700 text-white text-center py-3 sm:py-2">
          ...
          <section className="w-full py-12 md:py-16 bg-white">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="max-w-4xl mx-auto text-center mb-8 md:mb-12">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 md:mb-6">Mira Nuestro Video</h2>
                <p className="text-base sm:text-lg text-gray-600 px-2 sm:px-0">Conoce mi enfoque con 25 años de experiencia como Ingeniero Comercial y cómo mi consultoría hace crecer tu microempresa en Ecuador.</p>
              </div>
              <div className="max-w-4xl mx-auto aspect-video bg-black rounded-xl overflow-hidden shadow-xl relative">
                {!isVideoPlaying ? (
                  ...
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/BH0_NOjvwRo?autoplay=1&rel=0&showinfo=0&controls=1"
          ...
          <section className="w-full py-16 bg-gray-50">
            <div className="container mx-auto px-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="font-bold bg-blue-600 hover:bg-blue-700 whitespace-normal h-auto min-h-[44px] py-2 px-4">
                ...
                <Button size="lg" variant="outline" className="font-bold whitespace-normal h-auto min-h-[44px] py-2 px-4 text-black hover:text-black border-black hover:bg-gray-100">
                  <span className="text-sm sm:text-base">
