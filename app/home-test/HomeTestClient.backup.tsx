...
export default function HomeTestClient({ content, isEmotionalView }: { content: typeof pageContent.hoteles | typeof pageContent.restaurantes, isEmotionalView: boolean }) {
        ...
        <>
          ...
          <section className="w-full bg-[#121212] py-20">
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-3xl mx-auto text-center mt-16">
                <p className="text-xl italic text-gray-300">Imagina: Tu negocio gana estabilidad al conectar estos pasos con métricas precisas, convirtiendo datos en ventas medibles del 1-2% mensual.</p>
          ...
          <section className="w-full py-20 md:py-28 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900">No es Para Todos, Es Para Quienes Van en Serio</h2>
                <p className="text-lg text-gray-600 mt-4">Si estás buscando soluciones rápidas o atajos, mi consultoría no es para ti. Pero si estás comprometido con el crecimiento sostenible de tu negocio y estás dispuesto a invertir en una estrategia real, has llegado al lugar correcto.</p>
              </div>
          ...
          <section className="w-full py-20 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center mb-16">
                ...
                <p className="text-lg text-gray-600">Empresas y profesionales que han confiado en nuestra metodología y han visto resultados reales en sus negocios.</p>
              </div>
              <TestimonialSlider />
            </div>
          </section>
          ...
          <section className="w-full py-16 bg-white">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center mb-12">
                ...
                <p className="text-lg text-gray-600">Conoce más sobre nuestro enfoque y cómo podemos ayudarte a hacer crecer tu negocio</p>
              </div>
          ...
          <section className="w-full py-16 bg-gray-50">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Datos que no puedes ignorar sobre tu mercado</h2>
              <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
                En los últimos 12 meses en Loja: 67% de búsquedas de servicios locales fueron en Google, 45% de compras se investigaron online primero, 38% de negocios sin presencia digital perdieron clientes. Los datos son claros: adaptarse digitalmente no es opcional, es supervivencia empresarial.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="font-bold bg-blue-600 hover:bg-blue-700">Agenda tu consulta gratuita - Solo 5 cupos este mes</Button>
                <Button size="lg" variant="outline" className="font-bold">Ver nuestros casos de éxito</Button>
              </div>
            </div>
          </section>
