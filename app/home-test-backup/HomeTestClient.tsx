        ...
        >
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900">{pageContent.shared.choiceSection.hoteles.title}</h3>
            </div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900">{pageContent.shared.choiceSection.restaurantes.title}</h3>
            </div>
          </div>
