      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Descubre todas las herramientas que te ayudarán a optimizar tu comunicación y aumentar tu productividad.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-gray-50 p-6 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            ...
            <h4 className="text-xl font-semibold text-gray-700 mb-3">Mensajería Unificada</h4>
            <p className="text-gray-600">
              Centraliza todas tus conversaciones de WhatsApp, Facebook, Instagram, TikTok y web en una sola plataforma.
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            ...
            <h4 className="text-xl font-semibold text-gray-700 mb-3">Respuestas Automáticas</h4>
            <p className="text-gray-600">
              Configura respuestas automáticas inteligentes que se adaptan al contexto de cada conversación.
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            ...
            <h4 className="text-xl font-semibold text-gray-700 mb-3">Gestión de Agenda</h4>
            <p className="text-gray-600">
              Organiza citas y recordatorios de manera eficiente, con notificaciones automáticas.
            </p>
          </div>
