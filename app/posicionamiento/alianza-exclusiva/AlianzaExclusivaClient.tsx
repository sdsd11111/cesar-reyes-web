          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center py-16 md:py-24">
              ...
              <div className="max-w-4xl mx-auto mb-8 px-4">
                <HeroText 
                  fullText="Forma una sociedad estratégica que construye tu ecommerce y posiciona tu marca en Google, eliminando barreras financieras upfront. Desde 500 USD mensual por 24 meses, asumimos desarrollo valorado desde 1550 USD con SEO continuo, convirtiendo tráfico en ventas para pymes mientras diriges tu negocio."
                  shortText="Forma una sociedad estratégica que construye tu ecommerce y posiciona tu marca en Google, eliminando barreras financieras upfront. Desde 500 USD mensual por 24 meses, asumimos desarrollo valorado desde 1550 USD con SEO continuo, convirtiendo tráfico en ventas para pymes mientras diriges tu negocio."
