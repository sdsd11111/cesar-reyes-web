          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center py-16 md:py-24">
              ...
              <div className="max-w-4xl mx-auto mb-8 px-4">
                <HeroText 
                  fullText="Descubre cómo mejorar tu visibilidad en buscadores y convertir más visitantes en clientes con nuestro servicio integral de auditoría SEO y rediseño web. Analizamos, optimizamos y mejoramos tu presencia digital para obtener resultados reales."
                  shortText="Descubre cómo mejorar tu visibilidad en buscadores y convertir más visitantes en clientes con nuestro servicio integral de auditoría SEO y rediseño web. Analizamos, optimizamos y mejoramos tu presencia digital para obtener resultados reales."
