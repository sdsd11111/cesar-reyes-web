...
// --- DATA --- //
const heroImages = [
  '/images/categorias/analisis-estrategico/hero-1.webp',
  '/images/categorias/analisis-estrategico/hero-2.webp',
  '/images/categorias/analisis-estrategico/hero-3.webp',
];
...
const HeroText = ({ fullText, shortText, className = '' }: HeroTextProps) => {
  ...
  // Función para obtener las primeras 10 palabras
...
const ServicesTabs = ({ onOpenCalendar }: { onOpenCalendar: () => void }) => {
          ...
          {activeContent && (
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-gray-700">
              ...
              <button
                ...
                className="inline-block bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer"
              >
                {activeContent.cta}
              </button>
            </div>
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="relative text-white h-screen">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight shadow-text">Toma Decisiones Inteligentes: El Análisis Estratégico que Tu Pyme Necesita.</h1>
            <div className="mt-6">
              <HeroText
            ...
            <button
              ...
              className="mt-8 inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-blue-700 transition-transform transform hover:scale-105 cursor-pointer"
            >
      ...
      <section id="servicios" className="py-16 md:py-24 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <ServicesTabs onOpenCalendar={() => setIsCalendarModalOpen(true)} />
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
            <div className="lg:col-span-3 rounded-xl shadow-2xl overflow-hidden">
              <div className="aspect-video w-full">
                <iframe
                  className="w-full h-full"
                  src="https://www.youtube.com/embed/Gjcx5DAHrm4?si=YOUR_EMBED_CODE"
                  title="Análisis Estratégico para tu Negocio"
                  frameBorder="0"
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mt-12">
            <button
              onClick={() => setIsCalendarModalOpen(true)}
              className="bg-green-600 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-green-700 transition-colors cursor-pointer"
            >
