      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center text-white">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <HeroText 
              fullText="¿Tienes una gran idea pero no sabes por dónde empezar? ¿Te sientes estancado sin rumbo claro y temes invertir en lo incorrecto? La diferencia entre un sueño y un negocio próspero está en tener una estrategia sólida desde el inicio."
              shortText="¿Tienes una gran idea pero no sabes por dónde empezar? ¿Te sientes estancado sin rumbo claro y temes invertir en lo incorrecto? La diferencia entre un sueño y un negocio próspero está en tener una estrategia sólida desde el inicio."
